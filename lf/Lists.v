...
Theorem add_inc_count : forall (b : bag) (v : nat), count v (sum b [v]) = S (count v b).
Proof.
intros b v. induction b as [|h t IHt].
  - simpl. rewrite eqb_refl. reflexivity.
  - simpl. rewrite IHt. simpl. destruct (eqb h v) as [|].
    * reflexivity.
    * reflexivity.
Qed.
...
Proof.
  intros l1 l2. induction l1 as [|h1 t1 IHt1].
...
induction l as [| h t IHt].
- reflexivity.
- simpl. rewrite eqb_refl. rewrite <- IHt. reflexivity.
Qed. 
(** [] *)
...
Proof.
  intros s. induction s as [|h t IHt].
  - reflexivity.
  - simpl. destruct h as [| n'].
...
Proof.
  intros f H1. intros n1 n2. intros H2. rewrite H1. rewrite <- H2. rewrite <- H1. reflexivity.
Qed.
...
Proof.
  intro x. destruct x as [n]. simpl. rewrite eqb_refl. reflexivity.
Qed.
(** [] *)
...
(* FILL IN HERE *)
(*0 pcq ya pas de cas de base enculé*)
(** [] *)
