...
Proof.
  ...
  injection H1 as H1' H2'. rewrite <- H2' in H2. injection H2 as H2.
  transitivity z. apply H1'. symmetry. apply H2.
Qed. 
(** [] *)
...
Proof.
  intros n. induction n as [|n' IHn'].
  - intros m H. simpl in H. destruct m as [|m'] eqn:E. 
    + reflexivity.
    + simpl in H. discriminate H.
  - intros m H. destruct m as [|m'] eqn:E. 
   + simpl in H. discriminate.
   + f_equal. simpl in H. rewrite <- plus_n_Sm in H. rewrite <- plus_n_Sm in H. 
   injection H as H. apply IHn'. apply H.
Qed.
(** [] *)
...
Theorem nth_error_after_last: forall (n : nat) (X : Type) (l : list X),
  ...
  nth_error l n = None.
Proof.
  intros n X l. generalize dependent n. induction l as [|h t IHt].
  - simpl. intros n H. reflexivity.
  - simpl. intros n H. destruct n as [|n'] eqn:E. 
    + discriminate H.
...
Proof.
  ...
  - simpl. intros l1 l2 H. destruct h as [x y]. destruct (split t) as [lx ly]. 
    destruct l1 as [|h1 t1].
      + simpl. injection H as H1 H2. discriminate H1.
      + simpl. destruct l2 as [|h2 t2].
        * injection H as H1 H2 H3. discriminate H3.
        * injection H as H1 H2 H3 H4. rewrite H1. rewrite H3. f_equal. apply IHt.
...
Theorem bool_fn_applied_thrice :
  ...
  f (f (f b)) = f b.
Proof.
  intros f b. destruct b as [|] eqn:Eb.
...
Theorem eqb_sym : forall (n m : nat),
  (n =? m) = (m =? n).
Proof.
  intros n m. destruct (n =? m) as [|] eqn:E.
    - apply eqb_true in E. rewrite E. rewrite eqb_refl. reflexivity.
    - destruct (m =? n) as [|] eqn:E1.
      * apply eqb_true in E1. rewrite E1 in E. rewrite eqb_refl in E. symmetry in E. apply E.
      * reflexivity.
Qed. 
...
Theorem eqb_trans : forall n m p,
  ...
  n =? p = true.
Proof.
  intros n m p H1 H2. apply eqb_true in H1. apply eqb_true in H2. rewrite <- H1 in H2. rewrite H2.
  apply eqb_refl. 
Qed.  
  (** [] *)
...
Definition split_combine_statement : Prop
  ...
  := forall X Y (l : list (X * Y)) l1 l2, length l1 = length l2 -> combine l1 l2 = l -> split l = (l1, l2).

(* Theorem split_combine : split_combine_statement.
Proof.
  intros X Y l. induction l as [|h t IHt].
  - intros l1 l2 H1 H2. simpl. f_equal.
    ...
    + destruct l2 as [|h2 t2] eqn:E2.
      ...
      * destruct l1 as [|h1 t1] eqn:E1.
        -- simpl in H1. discriminate H1.
        -- simpl in H2. discriminate H2.
  - intros l1 l2 H1 H2. simpl. destruct h as [x y]. destruct (split t) as [lx ly]. 
  destruct l1 as [|h1 t1] eqn:E1.
    + simpl in H2. discriminate H2.
    + destruct l2 as [|h2 t2] eqn:E2.
      * simpl in H2. discriminate H2.
      * simpl in H1. simpl in H2. injection H1 as H1. injection H2 as H3 H4.
      rewrite H3. rewrite H4. apply IHt in H. injection H as H5 H6. rewrite H5. rewrite H6.
      reflexivity.
      apply H1.
Qed.  *)
...
Proof.
  ...
  - simpl. destruct (test h) as [|] eqn:E1.
    * intros H. injection H as H1 H2. rewrite H1 in E1. apply E1.
    * intros H. apply IHt in H. apply H.
Qed.
(** [] *)
...
Proof.
  ...
  - simpl. destruct (test h) as [|] eqn:E. 
    + simpl. unfold existsb'. simpl. rewrite E. reflexivity.
    + simpl. rewrite IHt. unfold existsb'. simpl. rewrite E. reflexivity.
Qed. 
